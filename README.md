...
git add .
git commit -m "Add all interview guide questions"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/c-interview-prep.git
git push -u origin main
```

**Settings → Pages → branch `main` → folder `/`**  
→ `https://YOUR_USERNAME.github.io/c-interview-prep/`
